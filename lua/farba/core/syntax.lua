...
function M.setup()
  ...
  local groups = {
    ...
    GlyphPalette1 = { fg = colors.general.red.v60 },
    GlyphPalette2 = { fg = colors.general.green.v60 },
    GlyphPalette3 = { fg = colors.general.yellow.v60 },
    GlyphPalette4 = { fg = colors.general.blue.v60 },
    GlyphPalette5 = { fg = colors.general.magenta.v60 },
    GlyphPalette6 = { fg = colors.general.cyan.v60 },
    GlyphPalette7 = { fg = colors.general.gray.v80 },
    ...
    GlyphPalette15 = { fg = colors.general.gray.v90 },
